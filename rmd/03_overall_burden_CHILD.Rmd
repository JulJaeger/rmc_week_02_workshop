...
The DALY burden (age-standardized rate) shows a consistent **decline across all three countries** from 1990 to 2019, indicating overall improvements in population health. **Ghana experienced the most significant reduction**, dropping from ~65,400 to ~45,965 a 30% decrease while **Cote d’Ivoire initially rose before steadily declining after 1998**. **Burkina Faso, although starting with the highest DALY rate, demonstrated a steady downward trend**, reflecting gradual but consistent health improvements over the decades.